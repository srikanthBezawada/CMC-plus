...
import org.cytoscape.cmc_plus.internal.results.renderer.HeightLimitedJLabelRenderer;
import org.cytoscape.cmc_plus.internal.util.StringUtils;
...
public class ResultViewerPanel extends JPanel implements TableModelListener {
	 ...
	 * Constructor
	 */
	public ResultViewerPanel(List<Complex> nodeSets) {
	 ...
	 * result viewer table.
	 */
	public List<Complex> getAllNodeSets() {
	 ...
	 */
	public Complex getSelectedNodeSet() {
	 ...
	 */
	public List<Complex> getSelectedNodeSets() {
		NodeSetTableModel model = this.getTableModel();
		List<Complex> result = new ArrayList<Complex>();
	 ...
	 */
	public void setNodeSets(List<Complex> set) {
