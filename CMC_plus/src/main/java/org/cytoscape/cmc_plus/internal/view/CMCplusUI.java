package org.cytoscape.cmc_plus.internal.view;
...
import org.cytoscape.cmc_plus.internal.logic.CMCplusLogic;
import org.cytoscape.cmc_plus.internal.logic.Complex;
import org.cytoscape.cmc_plus.internal.results.CytoscapeResultViewerPanel;
...
public class CMCplusUI extends javax.swing.JPanel implements CytoPanelComponent, NetworkAddedListener, NetworkDestroyedListener {
    ...
    private CMCplusLogic logicThread;
            
    public CMCplusUI(CyServiceRegistrar cyRegistrar) {
        initComponents();
    ...
    public void startComputation(){
        ...
        statusLabel.setText("CMC+ is running ......");
    }
    ...
    private void initComponents() {
        ...
        startB.setText("Run CMC+ on selected network");
        ...
        thresholdLabel.setText("Overlap Threshold for merging");

        overlapThresholdTf.setText("0.5");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainUIPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainUIPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainUIPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(mainUIPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(overlapThresholdTf, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void startBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBActionPerformed
        ...
        if(network != null){
            ...
            logicThread = new CMCplusLogic(this, network, networkview, mergeThreshold);
            logicThread.start();
    ...
    private void helpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpButtonActionPerformed
        ...
        openBrowser.openURL("apps.cytoscape.org/cmcplus");
