...
import org.cytoscape.cmc_plus.internal.results.standardgraph.Graph;
...
import org.cytoscape.cmc_plus.internal.results.renderer.FruchtermanReingoldLayoutAlgorithm;
import org.cytoscape.cmc_plus.internal.results.renderer.GraphRenderer;
import org.cytoscape.cmc_plus.internal.results.standardgraph.GraphLayoutAlgorithm;
import org.cytoscape.cmc_plus.internal.util.UniqueIDGenerator;
    ...
    */
	...
	public void setProgressIcon(Icon value) {
        ...
        public Graph convertCyNetworkToGraph(CyNetwork network, String weightAttr) {
                org.cytoscape.cmc_plus.internal.results.Graph graph = new org.cytoscape.cmc_plus.internal.results.Graph(network);
